...
in
{
  inherit makeShellScript makeShellInitModule;
  jvscripts = {
    ...
    cci-helpers       = final.callPackage ./pkgs/cci-helpers        { inherit self; };
    confluence-helpers = final.callPackage ./pkgs/confluence-helpers { inherit self; };
    jira-helpers      = final.callPackage ./pkgs/jira-helpers       { inherit self; };
